    ...
    <VStack spacing="5px">
      ...
      <FormControl id="choice" isRequired>
        <RadioGroup onChange={setValue} value={value}>
          <Stack direction="row">
            <Radio value="user">User Signup</Radio>
            <Radio value="expert">Expert Signup</Radio>
          </Stack>
        </RadioGroup>
      </FormControl>
      <FormControl id="password" isRequired>
        ...
        <InputGroup size="md">
          ...
          <InputRightElement width="4.5rem">{!show ? <ViewIcon onClick={handleClick} cursor="pointer"></ViewIcon> : <ViewOffIcon cursor="pointer" onClick={handleClick}></ViewOffIcon>}</InputRightElement>
        </InputGroup>
      </FormControl>
      <FormControl id="password" isRequired>
