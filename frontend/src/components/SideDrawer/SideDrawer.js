...
function SideDrawer() {
  ...
  return (
    <>
      <Box d="flex" justifyContent="space-between" alignItems="center" bg="black" w="100%" p="5px 10px 5px 10px">
        ...
        <div>
          ...
          <Menu>
            <MenuButton p={1}>
              ...
              <BellIcon fontSize="2xl" m={2} mr={5}/>
            </MenuButton>
            <MenuList pl={2}>
          ...
          <Menu>
            <MenuButton as={Button} bg="gray" rightIcon={<ChevronDownIcon />}>
